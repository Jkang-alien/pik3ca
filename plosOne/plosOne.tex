...
\begin{flushleft}
{\Large
\textbf\newline{Prediction of PIK3CA mutations from cancer gene expression data} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
